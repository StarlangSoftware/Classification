...
public class Combined5x2FTest extends ClassifierTest {
    ...
    public void testCompare() throws DiscreteFeaturesNotAllowed, StatisticalTestNotApplicable {
        ...
        assertEquals(0.684, combined5x2F.compare(experimentPerformance1, experimentPerformance2).getPValue(), 0.001);
        ...
        assertEquals(0.3863, combined5x2F.compare(experimentPerformance1, experimentPerformance2).getPValue(), 0.0001);
