...
public class Paired5x2tTest extends ClassifierTest {
    ...
    public void testCompare() throws DiscreteFeaturesNotAllowed, StatisticalTestNotApplicable {
        ...
        assertEquals(0.226, paired5x2t.compare(experimentPerformance1, experimentPerformance2).getPValue(), 0.001);
        ...
        assertEquals(0.9332, paired5x2t.compare(experimentPerformance1, experimentPerformance2).getPValue(), 0.0001);
        ...
        assertEquals(0.0, paired5x2t.compare(experimentPerformance1, experimentPerformance2).getPValue(), 0.0001);
        ...
        assertEquals(0.00945, paired5x2t.compare(experimentPerformance1, experimentPerformance2).getPValue(), 0.00001);
        ...
        assertEquals(0.164, paired5x2t.compare(experimentPerformance1, experimentPerformance2).getPValue(), 0.001);
    }
}