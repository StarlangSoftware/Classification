...
public class BaggingTest extends ClassifierTest{
    ...
    public void testTrain() {
        ...
        bagging.getModel().saveTxt("models/bagging-iris.txt");
        ...
        bagging.getModel().saveTxt("models/bagging-bupa.txt");
        ...
        bagging.getModel().saveTxt("models/bagging-dermatology.txt");
        ...
        bagging.getModel().saveTxt("models/bagging-car.txt");
        ...
        bagging.getModel().saveTxt("models/bagging-tictactoe.txt");
