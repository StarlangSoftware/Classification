...
public class C45StumpTest extends ClassifierTest{
    ...
    public void testTrain() {
        ...
        c45Stump.getModel().saveTxt("models/c45stump-iris.txt");
        ...
        c45Stump.getModel().saveTxt("models/c45stump-bupa.txt");
        ...
        c45Stump.getModel().saveTxt("models/c45stump-dermatology.txt");
        ...
        c45Stump.getModel().saveTxt("models/c45stump-car.txt");
        ...
        c45Stump.getModel().saveTxt("models/c45stump-tictactoe.txt");
        ...
        c45Stump.getModel().saveTxt("models/c45stump-nursery.txt");
        ...
        c45Stump.getModel().saveTxt("models/c45stump-chess.txt");
