...
public class DummyTest extends ClassifierTest{
    ...
    public void testTrain() {
        ...
        dummy.saveTxt("models/dummy-iris.txt");
        ...
        dummy.saveTxt("models/dummy-bupa.txt");
        ...
        dummy.saveTxt("models/dummy-dermatology.txt");
        ...
        dummy.saveTxt("models/dummy-car.txt");
        ...
        dummy.saveTxt("models/dummy-tictactoe.txt");
        ...
        dummy.saveTxt("models/dummy-nursery.txt");
        ...
        dummy.saveTxt("models/dummy-chess.txt");
