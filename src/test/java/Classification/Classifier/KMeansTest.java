...
public class KMeansTest extends ClassifierTest{
    ...
    public void testTrain() {
        ...
        kMeans.saveTxt("models/kMeans-iris.txt");
        ...
        kMeans.saveTxt("models/kMeans-bupa.txt");
        ...
        kMeans.saveTxt("models/kMeans-dermatology.txt");
        ...
        kMeans.saveTxt("models/kMeans-car.txt");
        ...
        kMeans.saveTxt("models/kMeans-tictactoe.txt");
        ...
        kMeans.saveTxt("models/kMeans-nursery.txt");
        ...
        kMeans.saveTxt("models/kMeans-chess.txt");
