...
public class RandomClassifierTest extends ClassifierTest{
    ...
    public void testTrain() {
        RandomModel randomClassifier = new RandomModel();
        Parameter parameter = new Parameter(1);
        randomClassifier.train(iris.getInstanceList(), parameter);
        randomClassifier.saveTxt("models/random-iris.txt");
        ...
        randomClassifier.saveTxt("models/random-bupa.txt");
        ...
        randomClassifier.saveTxt("models/random-dermatology.txt");
        ...
        randomClassifier.saveTxt("models/random-car.txt");
        ...
        randomClassifier.saveTxt("models/random-tictactoe.txt");
        ...
        randomClassifier.saveTxt("models/random-nursery.txt");
        ...
        randomClassifier.saveTxt("models/random-chess.txt");
