...
public class Paired5x2t extends PairedTest{
    ...
    private double testStatistic(ExperimentPerformance classifier1, ExperimentPerformance classifier2) throws StatisticalTestNotApplicable {
        ...
        if (classifier1.numberOfExperiments() != 10){
            throw new StatisticalTestNotApplicable("5x2 t test", "In order to apply a 5x2 test, you need to have 10 experiments.");
        }
        double[] difference;
        ...
        if (denominator == 0){
            throw new StatisticalTestNotApplicable("5x2 t test", "Variance is 0.");
        }
